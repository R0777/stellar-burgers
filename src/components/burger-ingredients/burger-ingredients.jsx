...
const [sous, setSous] = useState([])
  ...
  <div className={styles.ingredients__list}>
    <div className={styles.bulka__section}>
      ...
      {bulka.map(item => <BurgerBulka key={item._id} {...item} />)}
      </ul>
    </div>
    ...
    <div className={styles.sous__section}>
      ...
      {sous.map(item => <BurgerSous key={item._id} {...item} />)}
    ...
    <div className={styles.kotleta__section}>
      ...
      {kotleta.map(item => <BurgerKotleta key={item._id} {...item} />)}
      </ul>
    </div>
  </div>
